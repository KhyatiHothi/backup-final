function equalHeights() {
  ...
  function quiz_getstarted_slider() {
    ...
    // Biotera browse-assortment section slider
        var browse_assortment_flag = false;
        function browse_assortment_slider() {
           if (jQuery(".browse-assortment").length) {
          if (jQuery(window).innerWidth() > 767) {
           if (!browse_assortment_flag) {
            jQuery(".browse-assortment .browse-assortment-slider").slick({
                slidesToShow: 3,
                slidesToScroll: 1,
                arrows: true,
                dots: false,
            ...
            browse_assortment_flag = true;
          }
        } else {
          browse_assortment_flag = false;
        }
      }
   }
  ...
  function sideNavPosition(){
    ...
    var headerH = jQuery("#shopify-section-header .main-header").outerHeight(true);
    var topHeaderH = jQuery(".header-top").outerHeight(true);
    var total = headerH + topHeaderH;
    if (current_scroll > topHeaderH) {
      jQuery('.main-navigation.header-nav').css("top", headerH);
    }
    else {
      jQuery('.main-navigation.header-nav').css("top", total);
    }
  ...
  jQuery(document).ready(function () {
    ...
    // Biotera biotera-experts-section section slider
    if (jQuery(".biotera-experts-section").length) {
      jQuery(".biotera-experts-section .learn-how-to-video-grid").slick({
        slidesToShow: 4,
        slidesToScroll: 1,
        arrows: true,
        dots: false,
    ...
    if (jQuery(".biotera-blog-technique").length) {
      jQuery(".biotera-blog-technique .blog-grid-wrappper").slick({
        slidesToShow: 4,
        slidesToScroll: 1,
        arrows: true,
        dots: false,
  ...
  console.log(slider.$slides);
    ...
    // custom popup
    jQuery(document).on('click', `.custom-popup-link`, function(e){
      e.preventDefault();
