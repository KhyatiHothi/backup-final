function equalHeights() {
  ...
  jQuery(
    ".brands-slider-section .brands-slider-wrapper .slider-item"
  ).equalHeight();
  ...
  jQuery(
    ".collection-product-grid .collection-product-grid-item .product-link a h2"
  ).equalHeight();
  ...
  jQuery(
    ".result-contact-section .result-contact-grid .grid-inner .contact-item-content p"
  ).equalHeight();
}
  ...
  if (jQuery(window).width() <= 1199) {
    if (alreadyMobilized == 0) {
      ...
      jQuery(
        ...
        jQuery(this)
          .find(".header-menu-item-link")
          .attr("href", "javascript:void(0);");
      });
      jQuery(".mobile-header-navigation ul li.has-children a").click(function (
        e
      ) {
        e.preventDefault();
...
function thumbnail_slider() {
  if (jQuery(".productpage-gallery-thumbnails").length) {
    jQuery(".productpage-gallery-thumbnails").on("init", function (e, slider) {
      jQuery(slider.$slides.find(".thumbnail-image")).each(function (index) {
...
jQuery(document).ready(function () {
  ...
  jQuery(document).on(
    ...
    function () {
      ...
      jQuery(this)
        .closest(".productpage-main-inner")
        .find('.thumbnail-image[data-target="' + activeSlide + '"]')
        .trigger("click");
      jQuery(this)
        .closest(".custom-dropdown-wrapper")
  ...
  jQuery(document).on("click", `.custom-radio-input`, function () {
    ...
    jQuery(this)
      .closest(".productpage-main-inner")
      .find('.thumbnail-image[data-target="' + activeRadio + '"]')
      .trigger("click");
    jQuery(this)
      .closest(".custom-dropdown-wrapper")
  ...
  if (jQuery(".home-needs-section").length) {
    jQuery(".home-needs-section .home-needs-list").on(
      "init",
      function (e, slider) {
        jQuery(slider.$slides.find(".home-needs-text")).each(function (index) {
          jQuery(this).on("click", function () {
